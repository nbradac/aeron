...
static void aeron_send_channel_endpoint_manage(aeron_driver_managed_resource_event_t event, void *clientd);
    ...
    int64_t registration_id)
{
    ...
    _endpoint->conductor_fields.managed_resource.manage = aeron_send_channel_endpoint_manage;
...
void aeron_send_channel_endpoint_manage(aeron_driver_managed_resource_event_t event, void *clientd)
{
